...
contract('AuctionContract', function (accounts) {
  ...
  it("Should NOT allow to bid more than remaining tokens", function() {
    ...
    ***********/ // passed value and from which account
    ...
    .then(function (result) {
      ...
      */
      ...
      if(e === "Failed to check remaining tokens less than count") {
        ...
        ***********/
        /*<CODE HERE>*/
        assert(false, "remaining tokens is not enough"); // wapas revert ho jayega
     ...
     .then(function (instance) {
       ...
       */
       ...
       if(e === "Failed to check owner in reveal winners") {
        ...
        // assert true is like require(true) aage badhega sab set
    ...
    ***********/
    ...
    .then(function(result) {
      ...
      ***********/
      ...
      /**********
      // result is output of that called function
